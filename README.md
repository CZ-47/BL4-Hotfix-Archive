...
Shortly after, a new directory is added with the appropriate date containing the Patch/Hotfix notes and hopefully a zipped up folder with the hotfix files.
