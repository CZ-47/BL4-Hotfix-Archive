...
Gameplay & Missions
    ...
    Corrected Order drop pod events to consistently reach the ground and no longer appear stuck in the air
...
Harlowe the Gravitar
    ...
    Gravitar passive and Augment bonuses to Gun Damage now correctly apply to Ripper Heavy Weapon barrels and the Ripper Legendary Heavy Weapon Streamer; Entanglement interactions also function as designed
...
Balance Adjustments 
    ...
    There Is Only Red Duration restored no longer increases per point invested, and is now 4 seconds for all ranks.
        Dev Note: There Is Only Red was always meant to have huge damage scaling potential, but was always meant to be hard to maintain. We didn't want to nerf this passive's power, but we're making the effect harder to maintain. 
...
Crucible - Cybernetics
    ...
    Visuals corrected so Forgeaxes no longer disappear when activating Crucible at the same time as throwing with Double-Edge
...
Firmware:
    ...
    Action Fist now grants 30% Action Skill Damage at rank 2, up from 10%
...
The Weekly Wildcard Mission has changed. These missions feature a guaranteed Legendary drop that you can repeatedly earn to get your ideal roll.
    ...
    Mission: Dark Subject (Vampiric, Cold Hearted, Invisible)
    Legendary Gear Reward: Kickballer
